...
var Document = (0, import_react8.withEmotionCache)(
    ({ children }, emotionCache) => {
        const serverSyleData =
            import_react5.default.useContext(ServerStyleContext)
        const clientStyleData =
            import_react5.default.useContext(ClientStyleContext)
        ...
        return /* @__PURE__ */ import_react5.default.createElement(
            ...
            /* @__PURE__ */ import_react5.default.createElement(
                ...
                children,
                /* @__PURE__ */ import_react5.default.createElement(
                    import_react6.ScrollRestoration,
                    null,
                ),
                /* @__PURE__ */ import_react5.default.createElement(
                    import_react6.Scripts,
                    null,
                ),
                true
                    ? /* @__PURE__ */ import_react5.default.createElement(
                          import_react6.LiveReload,
                          null,
                      )
                    : null,
            ),
...
function SongsList({ songs }) {
    ...
    const headingSize = (0, import_react13.useBreakpointValue)({
        base: 'sm',
        md: 'md',
    })
    ...
    return /* @__PURE__ */ import_react12.default.createElement(
        ...
        /* @__PURE__ */ import_react12.default.createElement(
            ...
            user &&
                `Hey ${
                    user.firstName ||
                    ((_a = user.primaryEmailAddress) == null
                        ? void 0
                        : _a.emailAddress)
                }, here are your favorite songs:`,
        ),
        /* @__PURE__ */ import_react12.default.createElement(
            import_react13.UnorderedList,
            {
                textAlign: 'left',
            },
            songs.map(song =>
                /* @__PURE__ */ import_react12.default.createElement(
                    import_react13.ListItem,
                    {
                        key: song.id,
                    },
                    song.body,
...
function Index() {
    ...
    const headingSize = (0, import_react17.useBreakpointValue)({
        base: 'lg',
        sm: '2xl',
        lg: '4xl',
    })
    return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement(
                ...
                'Check the README file for instructions on how to get this project deployed.',
            ),
            /* @__PURE__ */ React.createElement(
                import_remix5.SignedOut,
                null,
                /* @__PURE__ */ React.createElement(
                    import_react17.Flex,
                    {
        ...
        /* @__PURE__ */ React.createElement(LogoBanner, null),
    )
}
...
var assets_manifest_default = {
    version: '89fe0afb',
    entry: {
        module: '/build/entry.client-TWBCX3ET.js',
        imports: [
            '/build/_shared/chunk-IOMVH2XD.js',
            '/build/_shared/chunk-EWCRA4YU.js',
        ],
    },
    routes: {
        root: {
            ...
            module: '/build/root-AB4LEOHB.js',
            imports: [
                '/build/_shared/chunk-2R2M4TBS.js',
                '/build/_shared/chunk-OJTP3DI7.js',
            ],
            hasAction: false,
            hasLoader: true,
        ...
        'routes/index': {
            ...
            index: true,
            caseSensitive: void 0,
            module: '/build/routes/index-DBGFDIGG.js',
            imports: void 0,
            hasAction: true,
            hasLoader: true,
        ...
        'routes/sign-in': {
            ...
            index: void 0,
            caseSensitive: void 0,
            module: '/build/routes/sign-in-MCOUATHJ.js',
            imports: void 0,
            hasAction: false,
            hasLoader: false,
            hasCatchBoundary: false,
        ...
        'routes/sign-up': {
            ...
            index: void 0,
            caseSensitive: void 0,
            module: '/build/routes/sign-up-6SWQKAWZ.js',
            imports: void 0,
            hasAction: false,
            hasLoader: false,
            hasCatchBoundary: false,
    ...
    url: '/build/manifest-89FE0AFB.js',
}
